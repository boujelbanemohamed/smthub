          ...
          <Card className="shadow-2xl bg-gradient-to-br from-white/95 to-blue-50/90 backdrop-blur-sm border-blue-200/50">
            ...
            <CardContent className="px-8 pb-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <Input
                    ...
                    required
                    disabled={loading}
                    className="mt-2 border-blue-200 focus:border-blue-400 bg-surface/80"
                  />
                </div>
                <div>
                  ...
                  <div className="relative mt-2">
                    <Input
                      ...
                      required
                      disabled={loading}
                      className="pr-11 border-blue-200 focus:border-blue-400 bg-surface/80"
                    />
                    <button
                      type="button"
                      ...
                      className="absolute inset-y-0 right-0 flex items-center px-3 text-blue-400 hover:text-blue-700 transition-colors"
                    >
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-blue-50 to-slate-50 rounded-lg border border-blue-200/50">
                ...
                <p className="text-sm font-mono bg-surface/60 px-3 py-2 rounded border border-blue-200">
                  admin / admin123
                </p>
              </div>
            </CardContent>
